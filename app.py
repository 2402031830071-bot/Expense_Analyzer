...
with tab1:
    ...
    with c1:
        ...
        ax.fill_between(monthly_df['month'], monthly_df['total'], alpha=0.2, color=YELLOW)
        ax.set_xticks(monthly_df['month'])
        ax.set_xticklabels([month_map[m] for m in monthly_df['month']], rotation=45, color=TEXT)
...
<table style='width:100%; border-collapse:collapse; background:#161b22; font-size:13px; table-layout:fixed;'>
  ...
  <thead>
    <tr style='background:#21262d;'>
      <th style='padding:14px 20px; text-align:left; color:#58a6ff; border-bottom:2px solid #30363d; font-weight:600;'>Category</th>
      <th style='padding:14px 20px; text-align:center; color:#58a6ff; border-bottom:2px solid #30363d; font-weight:600;'>Precision</th>
      <th style='padding:14px 20px; text-align:center; color:#58a6ff; border-bottom:2px solid #30363d; font-weight:600;'>Recall</th>
      <th style='padding:14px 20px; text-align:center; color:#58a6ff; border-bottom:2px solid #30363d; font-weight:600;'>F1-Score</th>
      <th style='padding:14px 20px; text-align:center; color:#58a6ff; border-bottom:2px solid #30363d; font-weight:600;'>Support</th>
    </tr>
  </thead>
  <tbody>
"""
    ...
    for i, cls in enumerate(classes):
      ...
      <td style='padding:12px 20px; color:#c9d1d9; border-bottom:1px solid #21262d; font-weight:500;'>{cls}</td>
      <td style='padding:12px 20px; text-align:center; color:{score_color(p)}; border-bottom:1px solid #21262d; font-weight:700;'>{p}</td>
      <td style='padding:12px 20px; text-align:center; color:{score_color(rec)}; border-bottom:1px solid #21262d; font-weight:700;'>{rec}</td>
      <td style='padding:12px 20px; text-align:center; color:{score_color(f1)}; border-bottom:1px solid #21262d; font-weight:700;'>{f1}</td>
      <td style='padding:12px 20px; text-align:center; color:#8b949e; border-bottom:1px solid #21262d;'>{sup}</td>
    </tr>
"""

    table_html += """    <tr style='background:#21262d;'>
    ...
    for key, label in summary_rows:
        if key in report_dict:
            ...
            if key == 'accuracy':
                ...
                f1  = f"{r['f1-score']:.2f}"
                sup = int(r['support'])
            table_html += f"""    <tr style='background:#161b22;'>
      <td style='padding:12px 20px; color:#e3b341; border-bottom:1px solid #21262d; font-weight:600;'>{label}</td>
      <td style='padding:12px 20px; text-align:center; color:#8b949e; border-bottom:1px solid #21262d;'>{p}</td>
      <td style='padding:12px 20px; text-align:center; color:#8b949e; border-bottom:1px solid #21262d;'>{rec}</td>
      <td style='padding:12px 20px; text-align:center; color:{score_color(f1)}; border-bottom:1px solid #21262d; font-weight:700;'>{f1}</td>
      <td style='padding:12px 20px; text-align:center; color:#8b949e; border-bottom:1px solid #21262d;'>{sup}</td>
    </tr>
"""
...
""", unsafe_allow_html=True)
    ...
    st.markdown(
        "<p style='color:#8b949e;font-size:0.85rem;margin-bottom:10px;'>💡 Quick Questions:</p>",
        unsafe_allow_html=True
    )
